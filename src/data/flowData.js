...
const edgeStyleRed = {
  style: { stroke: '#f47a3a', strokeWidth: 1.5 },
  markerEnd: { type: MarkerType.ArrowClosed, color: '#f47a3a' },
  label: 'NO',
  labelStyle: { fill: '#f47a3a', fontSize: 9, fontFamily: 'Courier New' },
...
export const INITIAL_EDGES = [
  ...
  { id: 'e5',    source: 'n-print', target: 'n-inc',   ...edgeStyle },
  {
    ...
    target: 'n-cond',
    type: 'smoothstep',
    style: { stroke: '#e8c84a55', strokeWidth: 1, strokeDasharray: '4 3' },
    markerEnd: { type: MarkerType.ArrowClosed, color: '#e8c84a55' },
    label: 'loop',
